...
```sh
curl -fsSL https://github.com/Bytonomics/cld-gateway/releases/latest/download/install.sh | sh -s -- --release 1.1.0
```
...
`GET /v1/models`. The gateway reads that file locally instead of calling OpenAI's
*api.openai.com/v1/models* endpoint.
